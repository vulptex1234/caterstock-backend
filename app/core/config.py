...
class Settings(BaseSettings):
    ...
    LINE_REDIRECT_URI: str = "https://caterstock-backend.onrender.com/api/v1/auth/line/callback"
    LINE_FRONTEND_REDIRECT_URI: str = "https://caterstock-frontend.vercel.app/auth/callback"
    ...
    CORS_ORIGINS: list[str] = [
        "https://caterstock-frontend.vercel.app",
        "http://localhost:3000"
    ]
